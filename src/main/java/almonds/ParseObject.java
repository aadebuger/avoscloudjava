...
public class ParseObject
{
	...
	public Hashtable<String, Object> mData;
		...
		for (String name : JSONObject.getNames(json))
		{
			try
			{
				...
				if (json.get(name).getClass().getName().equals("org.json.JSONObject"))
				{
					...
					if (json.get(name).getClass().getName().equals("org.json.JSONArray"))
					{
					System.out.println("org.json.JSONArray do not serial");	
					}
				else
				{
...
*/
			httpdelete.addHeader("X-AVOSCloud-Application-Id", Parse.getApplicationId());
			httpdelete.addHeader("X-AVOSCloud-Application-Key", Parse.getRestAPIKey());
	...
	public void save() throws ParseException
	{
		try
		{
			...
			httppost.addHeader("X-AVOSCloud-Application-Id", Parse.getApplicationId());
			httppost.addHeader("X-AVOSCloud-Application-Key", Parse.getRestAPIKey());
	...
	public void update( Hashtable<String, Object>  map) throws ParseException
	{
		try
		{
			HttpClient httpclient = new DefaultHttpClient();
//			HttpPut httppost = new HttpPost(Parse.getParseAPIUrlClasses() + mClassName);
		
			System.out.println("update="+getObjectId());
			HttpPut httpput = new HttpPut(Parse.getParseAPIUrlClasses() + mClassName + "/"
					+ getObjectId());
			httpput.addHeader("X-AVOSCloud-Application-Id", Parse.getApplicationId());
			httpput.addHeader("X-AVOSCloud-Application-Key", Parse.getRestAPIKey());
			httpput.addHeader("Content-Type", "application/json");

			httpput.setEntity(new StringEntity(toJSONObject(map).toString()));
	...
	private JSONObject toJSONObject(Hashtable<String, Object>  map)
	{
		JSONObject jo = new JSONObject();
